...
If you're having problem accessing `Actions.ref.your_component_ref`, try checking if it is undefined first before accessing it's values, like this example:
```
onEnter={() => {
